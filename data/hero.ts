export const heroData = {
    ...
    description: "Software Developer dedicated to building high-performance Digital Products | Bridging the gap between robust Backend logic and Intuitive User Design.",
    techStack: [
